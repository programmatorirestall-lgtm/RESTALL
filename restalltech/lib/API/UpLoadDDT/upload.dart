...
class UploadDDTApi {
  uploadImages(id, selectedImages) async {
    final String _url = apiHost + "/api/v1/ticket/allegati";
    ...
    for (var image in selectedImages) {
      ...
      final multipartFile = http.MultipartFile(
        'DDT ' + id.toString(), // Replace with your field name on the server
        stream,
        length,
        filename: image.name,
      );
...
//   updateAttached(file) async {
//     final String _url = apiHost + "/api/v1/ticket/allgati";
//     var _jwt = await _getJwt();
//     var _cookie = await _getCookie();
//     var headers = {
//       'Content-type': 'application/json',
