...
const String kSignerNullError = "Inserisci il firmatario";
const String kCittaNullError = "Inserisci la Città";
const String kManutetnzioneNullError = "Inserisci Costo Contratto";
const String kRSocNullError = "Inserisci la Rag. Sociale";
const String kMTRNullError = "Inserisci la matricola";
...
List<DropdownMenuItem<String>> kTypeMachine = <String>[
  'Caldo',
  'Freddo',
  'Climatizzazione',
  'Aspirazione',
...
List<DropdownMenuItem<String>> kVans = <String>[
  'M1 = FK281TD',
  'M2 = FF457LG',
  'M3 = FD615BS',
  'S4 = GB933AH',
