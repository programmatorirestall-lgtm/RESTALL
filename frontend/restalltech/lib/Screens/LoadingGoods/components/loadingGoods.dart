...
class LoadingGoods extends StatefulWidget {
  const LoadingGoods({super.key});

  @override
  _LoadingGoodsState createState() => _LoadingGoodsState();
}

class _LoadingGoodsState extends State<LoadingGoods> {
  String scannedCode = '';
  ...
  Widget build(BuildContext context) {
    return BackgroundForm(
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Prelievo Merci"),
        ),
                ...
                onPressed: isSendButtonEnabled()
                    ? () {
                        ...
                        if (summaryList.isNotEmpty) {
                          ...
                          FlutterPlatformAlert.showAlert(
                            windowTitle: 'Prelievo non completato',
                            text:
                                'Il prelievo non è stato effettuato correttamente.',
                            alertStyle: AlertButtonStyle.ok,
                            iconStyle: IconStyle.error,
                          );
                        }
