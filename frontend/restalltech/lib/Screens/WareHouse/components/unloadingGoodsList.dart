...
class UlList extends StatefulWidget {
  const UlList({Key? key}) : super(key: key);
  @override
  _UlListState createState() => _UlListState();
}

class _UlListState extends State<UlList> {
  ...
  static Future<List<Map<String, dynamic>>> _getProducts() async {
    final Response response = await WareHouseApi().getScarichi();
  ...
  _mockPullData() async {
    ...
    if (article.isEmpty) {
      ...
      FlutterPlatformAlert.showAlert(
        windowTitle: 'Non ci sono scarichi.',
